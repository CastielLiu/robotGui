...
void AddTopics::initUi()
{
    ...
    Camera->setIcon(0,QIcon("://rviz_icon/classes/Camera.png"));
    parent->addChild(Camera);


     DepthCloud=new QTreeWidgetItem(QStringList()<<"DepthCloud");
    DepthCloud->setIcon(0,QIcon("://rviz_icon/classes/DepthCloud.png"));
    parent->addChild(DepthCloud);

     Effort=new QTreeWidgetItem(QStringList()<<"Effort");
    Effort->setIcon(0,QIcon("://rviz_icon/classes/Effort.png"));
    parent->addChild(Effort);

     FluidPressure=new QTreeWidgetItem(QStringList()<<"FluidPressure");
    FluidPressure->setIcon(0,QIcon("://rviz_icon/classes/FluidPressure.png"));
    ...
    Map->setIcon(0,QIcon("://rviz_icon/classes/Map.png"));
    parent->addChild(Map);
    QTreeWidgetItem* Map_status=new QTreeWidgetItem(QStringList()<<"Status");
    Map_status->setIcon(0,QIcon("://rviz_icon/ok.png"));
